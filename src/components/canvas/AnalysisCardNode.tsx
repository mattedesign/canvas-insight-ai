...
import { AlertCircle, CheckCircle, Lightbulb, Sparkles, Loader2, FileText } from 'lucide-react';
import { ExpandableAnalysisPanel } from '@/components/ExpandableAnalysisPanel';
