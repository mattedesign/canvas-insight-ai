-- Phase A: Performance indexes for analysis_events and scheduled retention cleanup
...
-- Schedule daily cleanup at 02:00 UTC to retain last 60 days
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM cron.job WHERE jobname = 'cleanup_analysis_events_daily_v2'
  ) THEN
